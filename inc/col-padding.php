...
if ( get_sub_field( 'row_layout' ) == 'full_width' ) {
  ...
  .gc-row-' . $rowNum . ' > div {';
    ...
    elseif ($contentPadding['col_px']) :
      echo '
      padding-right: ' . $contentPadding['col_px'] . ';';
    endif;
    ...
    echo '@media (min-width: 768px) {
      .gc-row-' . $rowNum . ' > div {';
        ...
        elseif ($mdContentPadding['col_px']) :
          echo '
          padding-right: ' . $mdContentPadding['col_px'] . ';';
        endif;
...
if ( get_sub_field( 'row_layout' ) == 'halves' || get_sub_field( 'row_layout' ) == '3_6_3' || get_sub_field( 'row_layout' ) == '4_col') {
  ...
  .gc-row-' . $rowNum . '-col-1 {';
    ...
    elseif ($col_1_padding['col_px']) :
      echo '
      padding-right: ' . $col_1_padding['col_px'] . ';';
    endif;
...
if ( get_sub_field( 'row_layout' ) == 'halves' || get_sub_field( 'row_layout' ) == '3_6_3' || get_sub_field( 'row_layout' ) == '4_col') {
  ...
  .gc-row-' . $rowNum . '-col-2 {';
    ...
    elseif ($col_2_padding['col_px']) :
      echo '
      padding-right: ' . $col_2_padding['col_px'] . ';';
    endif;
...
if ( get_sub_field( 'row_layout' ) == '3_6_3' || get_sub_field( 'row_layout' ) == '4_col') {
  ...
  .gc-row-' . $rowNum . '-col-3 {';
    ...
    elseif ($col_3_padding['col_px']) :
      echo '
      padding-right: ' . $col_3_padding['col_px'] . ';';
    endif;
...
if ( get_sub_field( 'row_layout' ) == '4_col') {
  ...
  .gc-row-' . $rowNum . '-col-3 {';
    ...
    elseif ($col_4_padding['col_px']) :
      echo '
      padding-right: ' . $col_4_padding['col_px'] . ';';
    endif;
