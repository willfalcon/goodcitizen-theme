<?php
  /*
    2 Equal Columns template
  */

  $row = get_row_index();
 ?>

<div class="row gc-halves-row gc-row-<?php echo $row; ?> <?php if ( ! empty( $bgImg ) ) { echo 'gc-row-bg'; } ?> gc-theme-<?php the_sub_field( 'theme' ); echo gc_set_row_margins(); ?>">
  <div class="col-12 col-md-6 gc-row-<?php echo $row; ?>-col-1">
    <div class="d-flex flex-column gc-col  <?php echo gc_set_row_alignment(); ?>">
      ...
      <?php if ( have_rows( 'col_1_images' ) ) : while ( have_rows( 'col_1_images' ) ) : the_row(); ?>
        ...
        <img class="img-fluid gc-row-<?php echo $row . '-col-1-' . '-img-' . $imgNo; ?>" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
  ...
  <div class="col-12 col-md-6 gc-row-<?php echo get_row_index(); ?>-col-2 ?>">
    <div class="d-flex flex-column gc-col  <?php echo gc_set_row_alignment(); ?>">
      ...
      <?php if( have_rows( 'col_2_images' ) ) : while ( have_rows( 'col_2_images' ) ) : the_row(); ?>
        ...
        <img class="img-fluid gc-row-<?php echo $row . '-col-2-img-' . $imgNo; ?>" src="<?php echo $image['url']; ?>" alt="<?php echo $image['alt']; ?>" />
